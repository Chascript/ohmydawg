          ...
          <Grid container>
            ...
            <Grid container item xs={12} sm={8} justify="center" alignItems="center" spacing={2}>
              ...
              <Grid container item xs={12} sm={12}>
                ...
                <Grid item xs={8} sm={8}>
                  <Typography component="p">{props.dogName},</Typography>
                </Grid>
              </Grid>
              <Grid container item xs={12} sm={12}>
                <Grid item xs={4} sm={4}>
                  <Typography component="p">Breed:</Typography>
                </Grid>
                <Grid item xs={8} sm={8}>
                  <Typography component="p">{props.dogBreed},</Typography>
                </Grid>
              </Grid>
              <Grid container item xs={12} sm={12}>
                <Grid item xs={4} sm={4}>
                ...
                <Grid item xs={8} sm={8}>
                  <Typography component="p">{props.dogDateOfBirth},</Typography>
                </Grid>
              </Grid>
              <Grid container item xs={12} sm={12}>
                <Grid item xs={4} sm={4}>
                ...
                <Grid item xs={8} sm={8}>
                  <Typography component="p">{props.dogPunchline},</Typography>
                </Grid>
              </Grid>
              <Grid container item xs={12} sm={12}>
                <Grid container alignItems="flex-start" item xs={4} sm={4}>
                  <Grid item xs={5} sm={4}>
                    <Typography component="p">Personality:</Typography>
                  </Grid>
                </Grid>
                <Grid container item xs={8} sm={8}>
                  ...
                  <Grid item xs={12} sm={12}>
                    <Typography component="p">{props.dogPersonality.loving && 'Loving'}</Typography>
                  </Grid>
                  <Grid item xs={12} sm={12}>
                    <Typography component="p">
                  ...
                  <Grid item xs={12} sm={12}>
                    <Typography component="p">{props.dogPersonality.social && 'Social'}</Typography>
                  </Grid>
                  <Grid item xs={12} sm={12}>
                    <Typography component="p">
              ...
              <Grid container item xs={12} sm={12}>
                <Grid item xs={4} sm={4}>
                  <Typography component="p">About Me:</Typography>
                </Grid>
                <Grid item xs={8} sm={8}>
                  <Typography component="p">
        ...
        <DialogActions>
          <Grid container spacing={1} item sm={6} justify="center">
            <Grid item xs={10} sm={4}>
              <Button fullWidth variant="contained" color="primary" onClick={props.handleClose}>
                Edit Dog
              </Button>
            </Grid>
            <Grid item xs={10} sm={4}>
