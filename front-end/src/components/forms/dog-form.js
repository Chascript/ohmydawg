            ...
            <Hidden smUp>
              <Grid container item xs={12} alignItems="center" justify="center">
                ...
                <Grid item container justify="center" sm={12}>
                  <Typography component="p">Please Enter Your Dogs Information</Typography>
                </Grid>
              </Grid>
            </Hidden>
            <Grid
                ...
                >
                  ...
                  <Grid item xs={10} sm={5}>
                    ...
                    >
                      ...
                      {props.allBreeds.map((allBreeds) => (
                        <MenuItem key={allBreeds} value={allBreeds}>
                          {allBreeds}
                        </MenuItem>
                      ))}
                    </TextField>
                  ...
                  <Grid item xs={10} sm={5}>
                    ...
                    >
                      ...
                      <MenuItem
                        key="punchline1"
                        value={`Hey! I'm ${dogDetailsForm.dogName}, I love cuddles`}
                      >{`Hey! I'm ${dogDetailsForm.dogName}, I love cuddles`}</MenuItem>
                      <MenuItem
                        key="punchline2"
                        value={`It's ${dogDetailsForm.dogName}, off out on an Adventure!`}
                      >{`It's ${dogDetailsForm.dogName}, off out on an Adventure!`}</MenuItem>
                      <MenuItem
                        key="punchline3"
                        value={`I'm ${dogDetailsForm.dogName} and I like to sniff dog butts`}
                      >{`I'm ${dogDetailsForm.dogName} and I like to sniff dog butts`}</MenuItem>
                      <MenuItem
                        key="punchline4"
                        value={`What's up! It's ${dogDetailsForm.dogName} Chilling here`}
                      >{`What's up! It's ${dogDetailsForm.dogName} Chilling here`}</MenuItem>
                    </TextField>
                  </Grid>
                  <Grid item xs={10} sm={5}>
                    <MultilineTextBox
                      ...
                      handleChange={(e) =>
                        setDogDetailsForm({ ...dogDetailsForm, dogShortBio: e.target.value })
                      }
                    />
                  </Grid>
